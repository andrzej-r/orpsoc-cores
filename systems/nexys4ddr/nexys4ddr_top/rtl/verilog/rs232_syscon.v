...
parameter RD_DIGIT_COUNT_BITS_PP = 3;    // # of bits in the digits counter.
...
input [`NIBBLE_SIZE*DAT_DIGITS_PP-1:0] dat_i;
output [`NIBBLE_SIZE*DAT_DIGITS_PP-1:0] dat_o;
...
assign dat_o = (master_bg_i && we_l && stb_l)?
                 dat_sr:{`NIBBLE_SIZE*DAT_DIGITS_PP{1'b0}};
...
begin
  ...
  else if (capture_dat) dat_sr <= dat_i;
...
assign watchdog_timer_done = 1'b0;
